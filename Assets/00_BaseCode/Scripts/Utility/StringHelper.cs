...
public static class StringHelper
{
    ...
    public const string CURRENT_ERASE_POWERUP = "CURRENT_ERASE_POWERUP";
    public const string CURRENT_SAMECOLOR_POWERUP = "CURRENT_SAMECOLOR_POWERUP";
}
...
public class PathPrefabs
{
    ...
    public const string RATE_GAME_BOX = "UI/Popups/RatePopup";
    public const string SETTING_BOX = "UI/Popups/SettingPopup";

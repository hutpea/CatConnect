...
public class UseProfile : MonoBehaviour
{
    ...
    public bool OnMusic
    {
        get
        {
            Debug.Log(PlayerPrefs.GetInt(StringHelper.ONOFF_MUSIC, 1));
    ...
    public int CurrentRandomizePowerup
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.CURRENT_RANDOMIZE_POWERUP, 2);
        }
        set
        {
    ...
    public int CurrentErasePowerup
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.CURRENT_ERASE_POWERUP, 2);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.CURRENT_ERASE_POWERUP, value);
            PlayerPrefs.Save();
        }
    }

    public int CurrentSameColorPowerup
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.CURRENT_SAMECOLOR_POWERUP, 2);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.CURRENT_SAMECOLOR_POWERUP, value);
            PlayerPrefs.Save();
        }
    }
}

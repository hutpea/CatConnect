...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/00_BaseCode/KeyStore/connecttwocatsclassic.keystore";
    ...
    {
        string localPath = "Assets/00_BaseCode/Scenes/LoadingScene.unity";
    ...
    {
        string localPath = "Assets/00_BaseCode/Scenes/Gameplay.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
